      ...
      <div className="glass-card" style={{ textAlign: 'center', padding: '4rem 2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '2rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link href="/reiknivel" style={{ textDecoration: 'none' }}>
            <div style={{ background: 'rgba(245, 158, 11, 0.2)', border: '1px solid #f59e0b', padding: '2rem', borderRadius: '15px', width: '250px', transition: 'transform 0.3s ease, background 0.3s ease' }} className="menu-card">
              <h2 style={{ color: '#f59e0b', margin: '0 0 1rem 0' }}>Gagnamagn</h2>
              <p style={{ color: '#ddd', margin: 0 }}>Reiknaðu út gagnamagn og fjölda RAW mynda fyrir mismunandi vélar og minniskort.</p>
            </div>
          </Link>

          <Link href="/bokeh" style={{ textDecoration: 'none' }}>
            <div style={{ background: 'rgba(255, 255, 255, 0.05)', border: '1px solid rgba(255, 255, 255, 0.2)', padding: '2rem', borderRadius: '15px', width: '250px', transition: 'transform 0.3s ease, background 0.3s ease' }} className="menu-card">
              <h2 style={{ color: '#fff', margin: '0 0 1rem 0' }}>Bokeh Hermir</h2>
